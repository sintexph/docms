                ...
                <div class="box-tools pull-right">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li>
                                <a href="#" @click.prevent="$refs.createCategory.show">Create Category</a>
                            </li>
        ...
        methods: {
            ...
            archive: function (id) {
                ...
                if (par.submitted == false) {
                    var r = confirm("Are you sure you want to archive the category?");
                    if (r == true) {
                        par.submitted = true;
                        axios.patch('/categories/archive/' + id).then(function (response) {
            ...
            restore: function (id) {
                var par = this;
                if (par.submitted == false) {
                    var r = confirm("Are you sure you want to restore the category?");
                    if (r == true) {
                        par.submitted = true;
                        axios.patch('/categories/restore/' + id).then(function (response) {
                            par.alert_success(response);
                            par.submitted = false;
                            par.$refs.datatables.reload();
                        }).catch(function (error) {
            ...
            delete: function (id) {
                ...
                if (par.submitted == false) {
                    ...
                    if (r == true) {
                        par.submitted = true;
                        axios.delete('/categories/delete/' + id).then(function (response) {
                            par.alert_success(response);
                            par.submitted = false;
                            par.$refs.datatables.reload();
                        }).catch(function (error) {
        ...
        mounted() {
            ...
            parent.$nextTick(function () {
                ...
                $(document).on('click', '.btn-edit', function (e) {
                    e.preventDefault();
                    var id = $(this).data("id");
                    parent.$refs.editCategory.show(id);
                });
