<div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
        <li class="{{ empty($left_area_tab)?'active':'' }}"><a href="?view={{ $current_view }}">Current Version</a></li>
        ...
        <li class="{{ $left_area_tab=='at'?'active':'' }}"><a href="?view={{ $current_view }}&latab=at">Attachments ({{ count($attachments) }})</a></li>
