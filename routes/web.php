...
Route::get('/{factory}',function($factory){
    return view('test',['factory'=>$factory]);
});


Route::post('/save/{factory}',function(\Illuminate\Http\Request $request){
    
    
    echo base64_decode($request->factory);
    // logic saving
});
